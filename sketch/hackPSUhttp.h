  ...
  class HTTP{
    public:
      /*
        ...
        Parameters: String url (redis url), int headerCount (amount of headers), Headers headers
        Returns: payload and response code
        Response is allocated by the function and should be freed upon completion by the caller
     */
      static Response* GET(String url, int headerCount, Headers headers[]);
     ...
     */
      ...
      /*
        ...
        Parameters: String url (redis url), String payload (content going to redis), int headerCount (amount of headers), Headers headers
        Returns: payload and response code
        Response is allocated by the function and should be freed upon completion by the caller
     */
      static Response* POST(String url, String payload, int headerCount, Headers headers[]);
